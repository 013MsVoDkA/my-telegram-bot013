...
Главное: Фил не должен каждый раз превращать разговор в объяснение «Полина мне как сестра». Иногда он вообще не объясняет отношения, а просто раздражается от самого факта, что эту тему снова подняли.
