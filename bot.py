...
3. Используй легкие ласковые слова ("зай", "малышка"), но в меру — без перебора.
...
2. Можно добавить небольшую романтику, даже  флитр, НО В МЕРУ, соплей и ласковых слов ("зай" говорить ЗАПРЕЩЕНО).
